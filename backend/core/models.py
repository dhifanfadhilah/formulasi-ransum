...
class BahanPakan(models.Model):
    ...
    pk = models.DecimalField(max_digits=5, decimal_places=2)
    lk = models.DecimalField(max_digits=5, decimal_places=2)
    sk = models.DecimalField(max_digits=5, decimal_places=2)
    betn = models.DecimalField(max_digits=5, decimal_places=2)
    me = models.DecimalField(max_digits=10, decimal_places=2)
    ca = models.DecimalField(max_digits=5, decimal_places=2)
    p_total = models.DecimalField(max_digits=5, decimal_places=2)
    p_tersedia = models.DecimalField(max_digits=5, decimal_places=2)
